...
public class Program {
    ...
    static List<ToDoV1> prepareTasks() {
        ArrayList<ToDoV1> list = new ArrayList<>();
        list.add(new ToDoV1("Сходить в магазин"));
        list.add(new ToDoV1("Погулять с собакой"));
        list.add(new ToDoV1("Заменить лампочку"));
        return list;
    }
}
